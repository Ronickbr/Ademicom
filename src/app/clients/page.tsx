...
import { Plus, Search, User, Mail, Phone, MapPin, Loader2, X, ShieldCheck, Pencil, Trash2 } from "lucide-react";
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/5 bg-white/5">
                <th className="px-4 sm:px-6 py-4 text-left font-bold text-white uppercase tracking-wider text-xs whitespace-nowrap">Cliente</th>
                <th className="px-4 sm:px-6 py-4 text-left font-bold text-white uppercase tracking-wider text-xs whitespace-nowrap">Contato</th>
                <th className="px-4 sm:px-6 py-4 text-left font-bold text-white uppercase tracking-wider text-xs whitespace-nowrap">Documento</th>
                <th className="px-4 sm:px-6 py-4 text-left font-bold text-white uppercase tracking-wider text-xs whitespace-nowrap">Data Cadastro</th>
                <th className="px-4 sm:px-6 py-4 text-right font-bold text-white uppercase tracking-wider text-xs whitespace-nowrap">Ações</th>
              </tr>
            </thead>
                  ...
                  <tr key={client.id} className="hover:bg-white/5 transition-colors">
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-neutral-800 flex items-center justify-center text-muted-foreground border border-white/10 shrink-0">
                          <User className="h-5 w-5" />
                        </div>
                        <div>
                          <div className="font-bold text-white">{client.name}</div>
                          <div className="font-medium text-xs text-muted-foreground truncate max-w-[150px]">{client.address}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider border bg-white/5 text-muted-foreground border-white/10">
                        {client.tax_id || "N/A"}
                      </span>
                    </td>
                    <td className="px-4 sm:px-6 py-4 text-muted-foreground text-xs whitespace-nowrap">
