    ...
    <MainLayout>
      <div className="max-w-7xl mx-auto space-y-10 pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h1 className="text-3xl sm:text-5xl font-black tracking-tighter text-foreground uppercase italic">Dashboard <span className="text-primary not-italic font-light">Geral</span></h1>
