...
Este projeto utiliza o versionamento semântico. A versão atual é **v2.7.9**, representando uma evolução significativa na arquitetura e funcionalidades do sistema original.
